...
function home() {
	...
	document.getElementById('m1h').innerHTML = "Kerala state District wise active cases"
	document.getElementById('g1h').innerHTML = "Date wise cured & confirmed cases - Kerala state"
	document.getElementById('g2h').innerHTML = "Date wise deaths - Kerala state"
	document.getElementById('g3h').innerHTML = "District wise active case - Kerala state "
	document.getElementById('g4h').innerHTML = "Quarantine status(Home/Institutional & Hospitalized) - Kerala state"
	document.getElementById('g5h').innerHTML = "Age-wise COVID-19 Deaths in Kerala state"
  ...
  map.fitBounds([
	...
	window.kercon=parseInt(data[i-1][4]);
...
function world() {
	document.getElementById('g5h').innerHTML = "Recoverd , Confirmed & Death - Top 10 Countries"
...
document.getElementById(e).innerHTML = data[i][3];
			...
			var chart = c3.generate({
				...
				color: {pattern: ['#203e7e', '#328d3e','#ff0000']
	},
				axis: {
...
function dis() {
	...
	document.getElementById('g3h').innerHTML = "Confirmed cases comparing with other districts"
...
function sta() {
	...
	document.getElementById('m1h').innerHTML = "State  wise active cases - India"


	document.getElementById('g2h').innerHTML = "Confirmed cases comparing with other states"
	document.getElementById('g5h').innerHTML = "Recoverd , Confirmed & Death - Top 10 States"
...
document.getElementById(e).innerHTML = data[i][2];
  ...
  map.fitBounds([
	...
	function indiapiedata(data) {
		...
		var statecured=["Recovered"]
		var statedeath=["Death"]
		var name = ['x'];
...
console.log(statecase)
			var chart = c3.generate({
				...
				data: {
					...
					columns: [
						name,statecase,statecured,statedeath
				...
				color: {pattern: ['#355b68', '#328d3e','#ff0000']
	},
...
function displot(displotdata) {
	var c=document.getElementById("cars").value;
	document.getElementById('g1h').innerHTML = "Date wise cured & confirmed cases - "+(c)

	document.getElementById('g2h').innerHTML = ("Date wise deaths - "+c)
